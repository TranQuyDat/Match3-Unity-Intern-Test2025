using System;
using UnityEngine;
public enum CellType { board,bottomCell}
public class Cell : MonoBehaviour
{
    ...
    public void Setup(int cellX, int cellY, CellType cellType)
    {
        this.BoardX = cellX;
        this.BoardY = cellY;
    ...
    internal bool isNeighborsEmpty()
    {
        bool b = 
            (
                (this.NeighbourLeft == null || this.NeighbourLeft.Item ==null) &&
                (this.NeighbourRight == null || this.NeighbourRight.Item == null) &&
                (this.NeighbourUp == null || this.NeighbourUp.Item == null) &&
                (this.NeighbourBottom == null || this.NeighbourBottom.Item == null) 
            );
        return b;
    }
